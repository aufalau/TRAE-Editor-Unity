...
namespace Microsoft.Unity.VisualStudio.Editor
{
	...
	public class VisualStudioEditor : IExternalCodeEditor
	{
		...
		public void OnGUI()
		{
			...
			if (autoCopyRules != TraePreferences.AutoCopyProjectRules)
				TraePreferences.AutoCopyProjectRules = autoCopyRules;

			var includeExternal = EditorGUILayout.Toggle(new GUIContent("Include external packages", ""), TraePreferences.IncludeExternalPackages);
			if (includeExternal != TraePreferences.IncludeExternalPackages)
				TraePreferences.IncludeExternalPackages = includeExternal;

			var showLibrary = EditorGUILayout.Toggle(new GUIContent("Show Library folder", ""), TraePreferences.ShowLibrary);
			if (showLibrary != TraePreferences.ShowLibrary)
				TraePreferences.ShowLibrary = showLibrary;
